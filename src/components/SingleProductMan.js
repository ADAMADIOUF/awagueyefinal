...
const SingleProductMan = () => {
 const imgDiv = useRef(null)
  const { id } = useParams()
 const { closeSubmenu, productMan, index, setIndex } = useGlobalContext()
 const product = productMan.filter((product) => {
...
export default SingleProductMan